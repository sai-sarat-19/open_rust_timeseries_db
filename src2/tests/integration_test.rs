...
use crate::core::{
    config::{BufferConfig, UltraLowLatencyRecord},
    market_data::MarketDataRecord,
};
use crate::db::ultra_low_latency_db::UltraLowLatencyDB;
...
fn test_market_data_system() {
    ...
    let config = BufferConfig {
        ...
        max_write_latency: Duration::from_nanos(100),
        max_read_latency: Duration::from_nanos(50),
        use_simd: true,
    };

    // Create market data DB
    let db = Arc::new(UltraLowLatencyDB::new(config.buffer_size));
